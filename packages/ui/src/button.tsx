...
function Button({
	...
	// Base UI warns when `render` swaps in something that is not a <button> — a
	// Next <Link>, say — while `nativeButton` still claims one. Inferring it here
	// means call sites do not have to repeat the prop.
